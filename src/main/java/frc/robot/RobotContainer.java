...
import frc.robot.commands.TakeCommand;
import frc.robot.generated.TunerConstants;
import frc.robot.subsystems.CommandSwerveDrivetrain;
import frc.robot.subsystems.TakeSubsystem;

public class RobotContainer {
    public final TakeSubsystem m_TakeSubsystem = new TakeSubsystem();
    public final TakeCommand m_TakeCommand = new TakeCommand(m_TakeSubsystem);
    ...
    private void configureBindings() {
        joystick.rightBumper().onTrue(m_TakeSubsystem.intake());
